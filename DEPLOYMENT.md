...
**Error: "Failed to launch the browser process" or "error while loading shared libraries"**

This usually means Chromium dependencies are missing. Install required libraries:
